...
And User navigates to page 'Analysis'
...
Given User is logged In 'ORT'
And User navigates to page 'ContactSupport'
...
@Smoke
Scenario: User creates new report
Given User is logged In 'ORT'
And User navigates to page 'Reports'
...
@Smoke
Scenario: User creates new report using import
Given User is logged In 'ORT'
And User navigates to page 'Reports'
And tries to access 'New report'
